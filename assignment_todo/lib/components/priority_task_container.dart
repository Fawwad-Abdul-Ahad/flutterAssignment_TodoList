              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    width: double.infinity,
                    padding: EdgeInsets.only(left: 12),
                    child: Text("Mobile App UI Design",style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700,color: Colors.white),),
                  ),
                  Container(
                    height: 50,
                    width: double.infinity,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    width: double.infinity,
                    padding: EdgeInsets.only(left: 12),
                    child: Text("Capture Sun Rise Shorts",style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700,color: Colors.white),),
                  ),
                  Container(
                    height: 50,
                    width: double.infinity,
